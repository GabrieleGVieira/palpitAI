...
O frontend é o ponto de entrada do usuário no PalpitAI. Permite criar e entrar em grupos, registrar palpites antes do início de cada partida e acompanhar o ranking atualizado em tempo real via WebSocket. O app também exibe as previsões de resultado e placar geradas pelo pipeline de ML com explicações em linguagem natural.
